...
public class ConditionRecursive extends Condition {

    private Condition Condition;
    private ConditionTerm ConditionTerm;

    public ConditionRecursive (Condition Condition, ConditionTerm ConditionTerm) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ConditionRecursive(\n");
