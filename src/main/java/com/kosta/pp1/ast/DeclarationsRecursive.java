...
public class DeclarationsRecursive extends Declarations {

    private Declarations Declarations;
    private Declaration Declaration;

    public DeclarationsRecursive (Declarations Declarations, Declaration Declaration) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DeclarationsRecursive(\n");
