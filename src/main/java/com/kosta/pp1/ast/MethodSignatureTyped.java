...
public class MethodSignatureTyped extends MethodSignature {

    private Type Type;
    private String MethodName;
    private FunctionArgumentList FunctionArgumentList;

    public MethodSignatureTyped (Type Type, String MethodName, FunctionArgumentList FunctionArgumentList) {
        this.Type=Type;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MethodSignatureTyped(\n");
